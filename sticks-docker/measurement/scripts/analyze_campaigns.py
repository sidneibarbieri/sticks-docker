#!/usr/bin/env python3
"""
Compute Paper 1 values from the shared Enterprise ATT&CK bundle.

This script is the Paper 1 measurement entry point inside the frozen Docker
...
DEFAULT_BUNDLE = WORKSPACE_ROOT / "sticks" / "data" / "stix" / "enterprise-attack.json"
OUTPUT_JSON = MEASUREMENT_ROOT / "results" / "paper1_values_provenance.json"
OUTPUT_MD = MEASUREMENT_ROOT / "results" / "PAPER1_VALUES_PROVENANCE.md"
...
def main() -> None:
    ...
    macro_values = report["macro_values"]
    print("Paper 1 values generated from Docker-boundary measurement sources:")
