#!/usr/bin/env python3
"""
Build a Paper 1 findings report from the latest Docker runtime and Caldera
...
def write_results(payload: dict[str, Any]) -> tuple[Path, Path]:
    ...
    json_path = RESULTS_DIR / f"docker_execution_findings_{timestamp}.json"
    md_path = RESULTS_DIR / f"DOCKER_EXECUTION_FINDINGS_{timestamp}.md"
